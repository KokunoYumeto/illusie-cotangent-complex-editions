# Complexe cotangent et déformations — working editions
...
- a 380-page corrected-French standalone PDF;
- a 380-page source-aligned English standalone PDF;
- independently buildable French and English source packages;
- a shared machine-readable pre-Stacks scaffold, with no invented official
  Stacks tags;
